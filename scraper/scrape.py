...
COMPETITIONS = [
    {
        ...
        "output":  os.path.join(BASE_DIR, "data", "under-9s.json"),
        "division":"Cardiff & District Under 9s",
        "team":    "Cardiff Allstars Under 9s",
    },
    {
        "name":    "Under 12s",
        "url":     "https://comet.faw.cymru/resources/jsf/competition/index.xhtml?id=108490756",
        "output":  os.path.join(BASE_DIR, "data", "under-12s.json"),
        "division":"Cardiff & District Under 12s",
        "team":    "Cardiff Allstars Under 12s",
    },
    {
        "name":    "Under 16s",
        "url":     "https://comet.faw.cymru/resources/jsf/competition/index.xhtml?id=107459637",
        "output":  os.path.join(BASE_DIR, "data", "under-16s.json"),
        "division":"Cardiff & District Under 16s",
    ...
    },
    {
        ...
        "division":"Cardiff & District First Team",
    ...
    },
    {
        ...
        "division":"Cardiff & District Reserves",
